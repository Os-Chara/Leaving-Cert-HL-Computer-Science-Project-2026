# H1-Leaving-Cert-HL-Computer-Science-Project-2026
This is my LC Computer Science project from the 2025-2026 academic year. I received an overall grade of 100% after PMA was applied and the project itself was graded 85/90. The project focused on embedded systems and computer modeling. My project was a tree-mounted wildfire monitoring system created with a Raspberry Pi Pico W, and a python based model graphed using matplotlib.
